...
const Chat = ({ chat, setChat }) => {
    return (
        <div class="flex-1 w-[500px] p-2 sm:p-2 justify-between flex flex-col h-screen fixed top-0 right-2 bg-white border z-50">
            <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
                <div class="relative flex items-center space-x-4">
                    <div class="relative">
                        ...
                        <img
                            ...
                            alt=""
                            class="w-6 sm:w-14 h-6 sm:h-14 rounded-full"
                        />
                    </div>
                ...
                <div class="flex items-center space-x-2 text-blue-600 text-2xl">
                    <div>
                        <IoMdCall />
                    </div>
                    <div>
                ...
                <div class="chat-message">
                    <div class="flex items-end justify-end">
                        <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                            ...
                            <div>
                                <span class="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white ">
                                Nhưng theo mình vẫn nhờ vào sự kiên trì là nhiều nhất!
                                </span>
                            </div>
                        </div>
                        <img
